...
namespace Pokemon
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Pokemon Pikachu = new Pokemon("Pikachu", 10000, 10, 50, 2, move, Healingitem, 25, specialmove, buffingItem, "Splash", "Scratch", "Bomb");
            Pokemon Charizard = new Pokemon("Charizard", 100000, 10, 70, 1, move, Healingitem, 25, specialmove, buffingItem, "Splash", "Scratch", "Bomb");
